...
class thietke_model extends MY_Model {

    function __construct() {
        parent::__construct();
        $_table = $this->db->dbprefix('thietke');
        $this->_table = $_table;
    }
    ...
    function mostviewNews($catid = 1, $limit = 10) {
        $this->load->model('thietke_category_model');

        $str_catid = $catid;
        $sub_cats = $this->thietke_category_model->get_sub_cats($catid);
