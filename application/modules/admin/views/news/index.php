...
<form action="" method="get" name="filter_form">
    <div class="toppage">
        ...
        <?php if ($ADD_ACTION == TRUE): ?>
            <span class="btnadd"><a href="<?php echo admin_url($module . '/update/0/' . $redirect); ?>"><?php echo lang($MODULE . '_ADD_NEW'); ?></a></span>
        <?php endif; ?>
    </div>
...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column ta-center" style="width:40%;"><?php echo lang($MODULE . '_TITLE'); ?></div>
    ...
    <form action="" method="post">
        <?php foreach ($rows as $k => $row): ?>
            <div class="linecate">
                ...
                <div class="column ta-left" style="width: 21%;"><?php echo $row->cat_name ?></div>
