...
<div class="tableout">
    <div class="title1">
        ...
        <div class="column ta-center" style="width:6%;">Tiêu biểu</div>
        ...
        <?php foreach ($rows as $k => $row): ?>
            <div class="linecate">
                ...
                <div class="column" style="width:40%;" onmouseover="Hovercat('<?php echo $row->id; ?>')" onmouseout="Outcat('<?php echo $row->id; ?>')">
                    <a class="menu3000" target="_blank" href="<?php echo thietke_link($row->title_link); ?>"><?php echo $row->title ?></a><br />
                ...
                <div class="column ta-center" style="width: 6%;">
                    <?php if ($row->tieubieu == 0): ?>
                        <a href="<?php echo admin_url($module . '/tieubieu/' . $row->id . '/1' . '/' . $redirect) ?>"><img src="<?php echo img_link('pending.png', 'admin'); ?>" class="icon png" title="Kích hoạt" alt="Kích hoạt"></a>
                    <?php else: ?>
                        <a href="<?php echo admin_url($module . '/tieubieu/' . $row->id . '/0' . '/' . $redirect) ?>"><img src="<?php echo img_link('active.png', 'admin'); ?>" class="icon png" title="Hủy kích hoạt" alt="Hủy kích hoạt"></a>
                    <?php endif; ?>
                </div>
