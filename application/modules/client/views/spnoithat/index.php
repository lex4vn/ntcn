                    ...
                    foreach ($news as $i => $value) {
                        ...
                        <li class="item<?php echo $class ?>">
                            <div class="item-wrapper">
                                <h3 class="product-code"><a href="<?php echo $url ?>" title="<?php echo $view_title ?>"><?php echo $catid;echo ($category->id == 19 || $category->id == 93 || $category->id == 98 || $category->id == 101 || $category->pid == 19)? '':'Mã SP: '; ?><?php echo $value->code ?></a></h3>
