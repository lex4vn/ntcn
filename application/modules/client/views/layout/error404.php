...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h2>Noithatcnm.com</h2>
        <h2>Rất tiếc, Thông tin mà bạn yêu cầu không tồn tại.</h2>
        <h3>Qúy vị sẽ được chuyển tới trang chính <a href="<?php echo $uri_root ?>">Noithatcnm.com</a> trong 3 giây.</h3>
        <h3>Hoặc quý vị có thể click vào đây <a href="<?php echo $uri_root ?>">Noithatcnm.com</a> để trở về trang chủ</h3>
        <br/>
        Error 404
    </body>
</html>