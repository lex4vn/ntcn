        ...
        <div class="left">
            <ul class="news">
                <li class="news">
                    ...
                    <?php } ?>
                    <br/>
                    <div class="desc desc_inhome bold"><?php echo $row_news->short_desc ?></div>
                    <div class="clear"></div>
            ...
            <?php if (count($related_news)) { ?>
                <div class="other50">
                    <h5 style="color: #000; font-size: 11px; height: 17px; font-weight: normal; float:left; margin:0; width:100%; font-weight:bold">Những tin tức liên quan</h5>
                    <div class="cnt">
                        <?php
...
//                else
                            ...
                            <div class="item">
                                <a href="<?php echo $url ?>" title="<?php echo $view_title ?>" class="thumb">
                                    <img alt="<?php echo $view_title ?>" title="<?php echo $view_title ?>" width="149" height="99" src="<?php echo $img ?>" /></a>
